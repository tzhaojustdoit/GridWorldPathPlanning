...
void AStarPlanning::Expand(int id, const std::vector<bool> & obstacles, std::vector<Node*>& closed, PriorityQueue & open)
{
...
void AStarPlanning::Generate(int id, int parent_id, std::vector<Node*>& closed, PriorityQueue & open)
{
